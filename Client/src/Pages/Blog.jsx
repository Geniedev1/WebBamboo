...
export const Blog = () => {
  ...
  <button className="my-4 rounded-lg bg-amber-500 px-4 py-2 hover:bg-amber-600 focus:bg-amber-50 active:bg-blue-950">Click me</button>
  <ul className="my-2 flex flex-wrap space-y-0.5 max-md:justify-center md:justify-start">
   ...
   <div className = "m-4 shadow-xl rounded-2xl py-4 px-4 ring-1 ring-slate-900/5">
    <h3 className = "text-base font-medium text-slate-900 tracking-tight ">This is Text</h3>
    <p className = "mt-2  text-sm text-slate-500 ">This is mean</p>
    <button className = "mt-8 py-2 px-4 rounded-md font-medium bg-amber-500">Click To Dark</button>
   </div>
</main>
